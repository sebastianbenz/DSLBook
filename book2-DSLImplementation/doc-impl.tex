...
module, entity, function, var, return, screen, import
},
...
\lstdefinelanguage{nbl}{morekeywords={
module, namespaces, rules, defines, refers, non, unique, to, ordered, scopes, of, 
type, has, in, where, otherwise, surrounding, subsequent, imports, from, as,
transitive, scope
}}
