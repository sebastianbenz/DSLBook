...
% inline code fragment followed by optional linebreak
\newcommand{\icb}[1]{\changefont{cmtt}{m}{n}{#1}\linebreak[0]}  
...
\newcommand\GW[1]{\mynote{GW/TODO}{#1}} 
\newcommand\todo[1]{} 
\newcommand\updateSlides[1]{} 
\newcommand\ignore[1]{} % ignore text inside argument, e.g. to fix syntax highlighting with \ignore{$}
