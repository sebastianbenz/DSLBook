...
\newcommand{\embc}[1]{\excode{mbeddr C:}{#1}}
...
requires, composition, dynamic, query, registered, registration, parameters, 
oneway, message, request, reply, interface, struct, replicated, singleton,
consumes, publishes, update, publication, onchange, protocol, initial, state,
newimplof, newVersionOf, to, system
}}
...
state, entry, check, on, for, parameter, perform, after, isDown, 
true, false, prolog, assert, currentstate, is, mock, step
}}
...
\newcommand{\inlinecodesize}{\fontsize{10.4}{0}\selectfont}
\newcommand{\inlinecodesizesn}{\fontsize{8.4}{0}\selectfont}
\definecolor{inlinecodecolor}{gray}{0.3} 

\newcommand{\ic}[1]{\textbf{\inlinecodesize{\textcolor{inlinecodecolor}{\texttt{{#1}}}}}} 
\newcommand{\icsn}[1]{\textbf{\inlinecodesizesn{\textcolor{inlinecodecolor}{\texttt{{#1}}}}}} 
...
\def\titlerunning{DSL Engineering}
\def\authorrunning{Markus Voelter}


\begin{document}
\noindent
% \includegraphics[width=150mm]{dslengcover.png}
\input{body-sweng.ltx}
\nocite{*}
